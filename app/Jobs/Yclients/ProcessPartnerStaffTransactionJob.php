...
final class ProcessPartnerStaffTransactionJob implements ShouldQueue
{
    ...
    {
        return "yc_partner_staff_transaction_{$this->companyId}_{$this->date}";
    }
    ...
    public function handle(YcStaffScheduleService $service): void
    {
        ...
        try {
            ...
            $subJobs = array_map(
                fn (int $staffId) => new SyncYcStaffTransactionsJob($this->companyId, $staffId, $this->date),
                $activeStaffIds
            );
