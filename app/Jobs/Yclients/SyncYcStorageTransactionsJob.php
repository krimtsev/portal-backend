...
use App\Services\Yclients\SyncYcStorageTransactionService;
...
final class SyncYcStorageTransactionsJob implements ShouldBeUnique, ShouldQueue
{
    ...
    {
        return "yc_storage_transactions_{$this->companyId}_{$this->date}";
    }
    ...
    public function handle(SyncYcStorageTransactionService $service): void
    {
