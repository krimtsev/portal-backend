...
use App\Jobs\Yclients\SyncYcStaffWorkDaysJob;
use App\Models\Partner\Partner;
use Illuminate\Console\Command;
use Throwable;

final class SyncYcStaffWorkDaysCommand extends Command
{
    protected $signature = 'yclients:sync-staff-work-days
    ...
    protected $description = 'Синхронизация сотрудников которые работали из YClients';
    ...
    public function handle(PeriodResolutionService $periodService): int
    {
        ...
        foreach ($dates as $date) {
            ...
            foreach ($partners as $partner) {
                SyncYcStaffWorkDaysJob::dispatch(
