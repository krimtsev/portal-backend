...
final class SyncYcStorageTransactionsCommand extends Command
{
    protected $signature = 'yclients:sync-storage-transactions
    ...
    protected $description = 'Синхронизация товарных транзакций компании из YClients';
    ...
    public function handle(PeriodResolutionService $periodService): int
    {
        ...
        foreach ($dates as $date) {
            ...
            foreach ($partners as $partner) {
                SyncYcStorageTransactionsJob::dispatch(
